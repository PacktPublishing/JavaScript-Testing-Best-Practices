  ...
  (0, _mocha.describe)('getTestCasesFromFilesystem', () => {
    ...
    (0, _mocha.describe)('empty feature', () => {
      ...
      _asyncToGenerator(function* () {
        ...
        yield _fsExtra.default.outputFile(featurePath, '');
        this.result = yield (0, _helpers.getTestCasesFromFilesystem)({
          cwd: this.tmpDir,
    ...
    (0, _mocha.describe)('feature with scenario that does not match the filter', () => {
      ...
      _asyncToGenerator(function* () {
        ...
        yield _fsExtra.default.outputFile(featurePath, 'Feature: a\nScenario: b\nGiven a step');
        this.result = yield (0, _helpers.getTestCasesFromFilesystem)({
          cwd: this.tmpDir,
          eventBroadcaster: this.eventBroadcaster,
          featurePaths: [featurePath],
